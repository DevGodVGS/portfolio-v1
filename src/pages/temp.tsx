...
// ✅ Custom hook for card hover effect
...
// ✅ Child component so hooks are not inside map
    ...
    return (
        ...
        onError={(e) => {
          ...
          if (img.dataset.fallback !== "true") {
            img.src =
              fallbackImages[repo.name.toLowerCase()] ||
    ...
    useEffect(() => {
        ...
        const fetchRepos = async () => {
            try {
                ...
                if (isMounted) setRepos(reposWithTopics);
            } catch (err) {
                console.error(err);
                if (isMounted) setError("Failed to fetch projects. Please try again later.");
            } finally {
    ...
    if (loading || error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-black">
                ...
                >
                    Projects Made By DevGodVGS Loading....
                </motion.h1>
