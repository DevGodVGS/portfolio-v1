...
const FuturisticProgressBar: React.FC = () => {
    ...
    return (
        <motion.div className="fixed top-0 left-0 z-50 w-full" style={{ height: barHeight }}>
            <motion.div
                className="h-full shadow-[0_0_15px_rgba(0,255,255,0.8)] rounded-r-full relative overflow-visible"
    ...
    return (
        <section className="relative flex items-center justify-center min-h-screen w-full bg-gradient-to-br from-gray-900 via-indigo-900 to-black overflow-hidden px-6">
            ...
            {skills.map((skill, i) => (
                ...
                >
                    <motion.div className="p-3 rounded-2xl bg-white/20 backdrop-blur-md border border-white/20 shadow-lg"
